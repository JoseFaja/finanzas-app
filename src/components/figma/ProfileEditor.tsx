...
function ProfileEditorContent({
  ...
  documentTypes,
  onSave,
}: Omit<ProfileEditorProps, "isOpen">) {
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(event) =>
                setEditedProfile({ ...editedProfile, nombre: event.target.value })
              }
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(event) =>
                setEditedProfile({ ...editedProfile, apellido: event.target.value })
              }
            />
          </div>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      {isOpen ? (
        <ProfileEditorContent
          key={`${profile.id}-${profile.googleImage ?? ""}`}
          onClose={onClose}
          profile={profile}
